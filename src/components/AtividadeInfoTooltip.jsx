...
export default function AtividadeInfoTooltip({ tipo }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        <TooltipContent side="right" className="bg-[#1a1a1a] border-gray-700 max-w-xs">
          <div className="space-y-2">
            <h4 className="font-semibold text-white">{info.titulo}</h4>
            <p className="text-sm text-gray-300">{info.descricao}</p>
            <div className="pt-2 border-t border-gray-700">
              <p className="text-xs font-medium text-gray-400 mb-1">Foco da avaliação:</p>
